...
import helium314.keyboard.settings.screens.AutopilotScreen
...
fun SettingsNavHost(
    ...
    NavHost(
        ...
        composable(SettingsDestination.Autopilot) {
            AutopilotScreen(onClickBack = ::goBack)
        }
        ...
        composable(SettingsDestination.SonderTheme) {
            SonderThemeScreen(onClickBack = ::goBack)
        }
